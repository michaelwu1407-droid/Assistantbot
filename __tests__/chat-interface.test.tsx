...
describe('ChatInterface', () => {
  it('renders chat interface with initial message', () => {
    ...
    expect(screen.getByText("Hi! I'm Travis, your personal assistant. Here to give you an earlymark!")).toBeInTheDocument();
  ...
  it('displays user and assistant messages correctly', () => {
    ...
    const assistantMessage = screen.getByText("Hi! I'm Travis, your personal assistant. Here to give you an earlymark!");

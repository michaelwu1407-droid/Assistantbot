      ...
      <div className="bg-white border-b px-6 py-4 flex justify-between items-center shrink-0">
        <div>
          ...
          <p className="text-sm text-slate-500">
            {initialDeals.length} locations mapped • {pendingCount} pending geocoding
          </p>
        </div>
        ...
        <div className="w-80 bg-white border-r overflow-y-auto flex flex-col shrink-0">
          ...
          {initialDeals.length === 0 ? (
            <div className="p-8 text-center text-slate-500">
              ...
              <p>No mapped jobs found.</p>
              <p className="text-xs mt-1">Add addresses to your deals to see them here.</p>
            </div>
          ) : (

...
function getSentiment(score: number) {
    ...
    return { label: "At Risk", color: "bg-destructive/10 text-destructive border-destructive/20" };
}
                    ...
                    <div className="space-y-2">
                        {!resolving ? (
                            <div className="flex items-center gap-2 p-3 rounded-lg bg-destructive/5 border border-destructive/10">
                                ...
                                <p className="text-xs text-destructive dark:text-destructive flex-1">Low score — resolve before client posts a public review</p>
                                <Button size="sm" variant="outline" className="border-destructive/20 text-destructive hover:bg-destructive/10" onClick={() => setResolving(true)}>
                                    Resolve
                                </Button>
                            </div>
                        ) : (

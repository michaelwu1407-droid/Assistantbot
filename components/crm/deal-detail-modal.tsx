        ...
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-0.5">
              {deal.source ? deal.source.charAt(0).toUpperCase() + deal.source.slice(1) : "Direct enquiry"} • <span className="text-emerald-600 font-medium">${Number(deal.value || 0).toLocaleString()}</span>
            </p>
          </div>
        </div>

...
export function SetupWidget() {
    ...
    return (
        <div className="bg-card dark:bg-slate-900 border border-emerald-200 dark:border-emerald-800 rounded-md overflow-hidden mb-6 shadow-sm transition-all duration-300">
            <div
                ...
                <div className="p-4 bg-card dark:bg-slate-900 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 border-t border-emerald-100 dark:border-emerald-800/50">
                    {data.steps.map((step) => (
                        <Link key={step.id} href={step.href}>
                            <div className={`flex items-center gap-3 p-3 rounded-md border transition-colors group ${step.isComplete

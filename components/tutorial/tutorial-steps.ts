...
export const TUTORIAL_STEPS: TutorialStep[] = [
    ...
    { id: "nav-settings", targetId: "settings-link", title: "⚙️ Workspace Settings", message: "Use the left menu to jump to any tab: **Profile**, **Help**, **Phone** & **Support**, **Account** & **Billing**, **Notifications**, **Workspace** & **Display**, **One-Tap Messages**, **Automations**, **Integrations**, **AI Voice Agent**, **Agent Capabilities** (including WhatsApp Assistant), and **Repair Glossary**.", actionLabel: "Next" },

...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "inline-flex h-11 items-center justify-center rounded-full bg-[#F1F5F9] p-1 text-muted-foreground",
            className
        )}
        {...props}
    />

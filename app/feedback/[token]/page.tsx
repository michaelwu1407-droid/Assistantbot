    ...
    <main className="min-h-screen bg-muted/30 px-4 py-10 text-foreground">
      <div className="mx-auto flex max-w-2xl flex-col gap-6">
        <div className="space-y-2 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-muted-foreground">Earlymark feedback</p>
          <h1 className="text-3xl font-semibold tracking-tight text-foreground">Share your experience</h1>

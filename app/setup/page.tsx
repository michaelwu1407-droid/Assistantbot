    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
            <div className="text-center mb-8 space-y-2">
                <h1 className="text-3xl font-bold text-foreground tracking-tight">Welcome to Pj Buddy</h1>
                <p className="text-muted-foreground">Let&apos;s personalize your assistant.</p>
            </div>

...
const sidebarNavSections: { label?: string; items: { title: string; href: string }[] }[] = [
    {
        items: [
            { title: "Account", href: "/crm/settings" },
        ],
    },
    {
        items: [
    ...
    {
        items: [
            { title: "AI Assistant", href: "/crm/settings/agent" },
        ],
    },
    {
        items: [
            { title: "Integrations", href: "/crm/settings/integrations" },
        ],
    },
    {
        items: [
            { title: "Notifications", href: "/crm/settings/notifications" },
        ],
    },
    {
        items: [
            { title: "Billing", href: "/crm/settings/billing" },
        ],
    },
    {
        items: [
            { title: "Display", href: "/crm/settings/display" },
        ],
    },
    {
        label: "Other",
        items: [
            { title: "Data & Privacy", href: "/crm/settings/privacy" },
        ],
    },
    {
        items: [
            { title: "Help", href: "/crm/settings/help" },
        ],
    },
]

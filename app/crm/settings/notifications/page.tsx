    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Configure real email and in-app notification behavior. Call and message behavior is managed in Calls & texting.</p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-xs text-muted-foreground">
            Timing rules: task reminders fire at your agenda and wrap-up times from My business (Working hours). Stale alerts are generated by the stale-job detection workflow.
          </p>
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">

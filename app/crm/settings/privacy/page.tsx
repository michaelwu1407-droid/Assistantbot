...
export default function PrivacySettingsPage() {
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-medium text-foreground dark:text-white">Data and privacy</h3>
      ...
      <Card className="border-border shadow-sm dark:border-slate-800">
        ...
        <CardContent className="space-y-4">
          ...
          <ul className="list-inside list-disc space-y-2 text-sm text-muted-foreground dark:text-muted-foreground">
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="border-b border-border dark:border-slate-700">
                  <th className="py-2 pr-4 text-left font-medium text-foreground dark:text-slate-300">Data type</th>
                  <th className="py-2 text-left font-medium text-foreground dark:text-slate-300">Retention period</th>
                </tr>
              </thead>
              <tbody className="text-muted-foreground dark:text-muted-foreground">
                <tr className="border-b border-border/50 dark:border-slate-800">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="border-b border-border dark:border-slate-700">
                  <th className="py-2 pr-4 text-left font-medium text-foreground dark:text-slate-300">Provider</th>
                  <th className="py-2 text-left font-medium text-foreground dark:text-slate-300">Purpose and data shared</th>
                </tr>
              </thead>
              <tbody className="text-muted-foreground dark:text-muted-foreground">
                <tr className="border-b border-border/50 dark:border-slate-800">

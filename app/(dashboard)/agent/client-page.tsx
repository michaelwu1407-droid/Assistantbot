  ...
  return (
    <div className="h-full w-full bg-muted/30 text-foreground flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* 2. Header */}
        <header className="h-20 border-b border-border bg-card px-6 flex items-center justify-between shrink-0">
        ...
        <main className="flex-1 overflow-x-auto p-6 bg-muted/20">
              ...
              return (
                <div key={stage} className="w-72 flex flex-col h-full">
                  <div className="flex items-center justify-between mb-3 px-1">
                    <h3 className="font-semibold text-foreground text-sm uppercase tracking-wide">{stage}</h3>
                    <span className="bg-muted text-muted-foreground text-[10px] font-bold px-1.5 py-0.5 rounded">{deals.length}</span>
                  </div>
                  <div className="flex-1 bg-muted/30 rounded-xl p-2 border border-border/60 overflow-y-auto">
                    {deals.map(deal => (
      ...
      <div className="w-80 border-l border-border bg-card flex flex-col">
        <div className="p-4 border-b border-border/50">
          <h3 className="font-semibold text-sm text-foreground">Matchmaker Feed</h3>
        </div>
        <ScrollArea className="flex-1 p-4">
          <div className="space-y-4">
            <div className="p-3 bg-blue-50 rounded-lg border border-blue-100">
              ...
              <p className="text-sm text-foreground mb-2">3 Buyers found for <strong>12 Smith St</strong></p>

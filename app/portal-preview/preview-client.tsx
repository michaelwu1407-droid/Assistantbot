            ...
            {STATUS_CHOICES.map((choice) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1 text-sm font-semibold text-foreground">{choice.label}</p>
                </button>
              );
            })}
          </div>
          ...
          <div className="w-full max-w-[420px] rounded-md border border-border/10 bg-[#dfe9ef] p-3 shadow-[0_30px_120px_rgba(15,23,42,0.18)]">
            <div className="overflow-hidden rounded-md border border-border/10 bg-muted/30">
              ...
              <div className="-mt-4 space-y-4 px-4 pb-5">
                        ...
                        return (
                          <li key={step.key} className="flex items-start gap-4">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="mt-1 text-sm leading-6 text-muted-foreground">{step.blurb}</p>
                            </div>
                          </li>
                        );
                      })}
                ...
                <p className="pb-2 text-center text-[11px] font-medium uppercase tracking-[0.22em] text-muted-foreground">

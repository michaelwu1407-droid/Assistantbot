 ...
 * NOTE: Stubbed - requires OpenHouseLog and BuyerFeedback models in Prisma schema.
 */
...
<tbody><tr><td colspan="2" style="padding:8px;text-align:center;color:#94a3b8">No feedback recorded yet</td></tr></tbody></table>
